...
public class EmailController {
    ...
    public ResponseEntity<Map<String, String>> confirmEmailProcess(@RequestParam("email") String email,
                                                                   HttpSession session) {
        try {
            // 이메일 인증 로직 수행
    ...
    public ResponseEntity<Map<String, Boolean>> verifyEmailProcess(@RequestParam("code") String code, HttpSession session) {
        try {
            // 세션에서 인증 코드를 가져옴
